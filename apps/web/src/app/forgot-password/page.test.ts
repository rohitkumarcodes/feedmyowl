...
import ForgotPasswordPage, { dynamic } from "@/app/forgot-password/page";
...
describe("forgot-password page", () => {
  ...
  it("redirects signed-in users to /feeds", async () => {
    ...
    await expect(ForgotPasswordPage()).rejects.toBe(redirectError);
    expect(mocks.redirect).toHaveBeenCalledWith("/feeds");
  });

  it("renders reset-password UI for signed-out users", async () => {
