...
- Updated markdown product docs to reflect new search behavior and shortcut map.
- Updated public `/docs/` keyboard guidance and added a dedicated article-search section.

Follow-up (2026-02-11): platform hardening for feed writes/fetches is now in place, including feed fetch hardening (SSRF blocking, redirect revalidation, timeout + retries), conditional fetch support (ETag / Last-Modified), and reliable dedupe with DB uniqueness.
